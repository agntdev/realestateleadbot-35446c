...
export type OwnerAwareCtx = {
  ...
  // grammY's optional reply options are narrower than `unknown`; `any` here
  // intentionally accepts all compatible reply signatures without changing
  // what this small identity helper calls (it passes only text).
